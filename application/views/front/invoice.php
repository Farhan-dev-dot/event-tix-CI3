    ...
    <div class="container my-3" style="border: 2px outset green;">
        ...
        <div class="invoice mb-3">
            <div class="row mb-3 p-3">
                <div class="col-6">
                    <h3 style="color:success"><b>Pagelaran Seni Budaya</b></h3>
                </div>
                <div class="col-6">
                ...
                <div class="col-6">
                    ...
                    <p class="mb-0"><i class="fas fa-angle-right"></i>
                </div>
                <div class="col-6">
                    <br><br>
                    <p class="mb-0"><b>Ticket Code:</b> <?php echo "#".$order['o_id']; ?></p>
                    <?php $cDate = strtotime($order['success-date']); ?>
                    <p class="mb-0"><b>Order Date:</b> <?php echo date('d-M-Y',$cDate); ?></p>
                    <p class="mb-0"><b>Metode pembayaran:</b> Transfer</p>
                </div>
        ...
        <footer class="text-center">
            <p class="mb-0">Terima kasih telah mendukung seniman lokal!</p>
            <p>Kami berharap dapat bertemu dengan Anda lagi.</p>
            <p>For terms & conditions Please visit www.culturetix.id</p>
        </footer>
    </div>
    <div class="container text-center">
        <a href="<?php echo base_url().'orders' ?>" class="btn btn-sm btn-success p-2"><i class="fas fa-angle-left"></i>
            Back to Orders</a>
    </div>
