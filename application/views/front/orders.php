            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody id="myTable">
                    ...
                    <tr>
                        ...
                        <td> <button type="button" class="btn btn-secondary" style="font-weight:bold;"><i class="fas fa-bars"></i> Proses</button></td>
                        <?php } if($status=="in process") { ?>
                        <td> <button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin" aria-hidden="true"></span> in verification!</button></td>
                        <?php }?>
            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody id="myTable">
                    ...
                    <tr>
                        ...
                        <td><?php echo $order['quantity']; ?></td>
                        <td><?php echo 'Rp. '.$order['price']; ?></td>
                        <td> <button type="button" class="btn btn-success"><i class="fas fa-check"></i> finished</button>
